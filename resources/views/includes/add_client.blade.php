    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
               <h4 class="modal-title"><b>Add Client Transaction</b></h4>
                ...
                <form class="form-horizontal" method="POST" action="{{ route('clients.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a href="#addnewcustomer" data-toggle="modal"  class="btn btn-primary">New</a>
                            </div>
                        </div>
...
<div class="modal fade" id="addnewcustomer">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><b>Add Cient</b></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="{{ route('clients-customer') }}">
                    @csrf
                    <div class="form-group">
